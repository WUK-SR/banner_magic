...
const DealsHP = (cat, title_one, title_two, was_price, now_price, img_link, generic_message, message_two_a, message_two_b, promo, promo_text, code, url_link) => {
  ...
  if(promo === "YES") {
    ...
    <div class="sw_layout--content">
      <div style="margin-bottom:0;width: 960px;position:relative; height:340px; border: 1px solid #000;overflow:hidden;">
        ...
        <a style="text-decoration:none;" href="${url_link}" title="View this offer">
          ...
          <h3 style="transition: all .5s;text-align: left;color: #fff;font-size: 35px;margin: 0;"> Big brands. </h3>
            ...
            <img style="position: absolute;height: auto;width: 312px;left: 609px;top: 15px;" src="${img_link}" alt="Great deals at wolseley.co.uk">
            ...
            <div style="position:relative;top: 380px;left: 616px;">
              <div style="background-color:#C42C2D;" class="sw_deals__callout sw_deals__callout--half sw_deals__callout--dark">
                  ...
                  <div class="sw_deals__callout-hex-wrapper sw_deals__callout-hex-wrapper--dark">
                      ...
                      </svg> <span style="color:#C42C2D;" class="sw_deals__callout-saving sw_deals__callout-saving--text"> Great Value</span></div>
              </div>
          </div>
