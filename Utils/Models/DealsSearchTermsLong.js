...
const DealsSearchTermsLong = (cat,message,percentage) => {
  ...
  return (
    `<div class="sw_layout--content">
          <div style="width:937px;height:150px!important;margin-bottom:15px;position:relative;margin-top:5px; box-sizing:border-box; height:130px; background-color: #fff; display:inline-block;">
            ...
            <svg viewBox="0 0 330.5 309" style="position:absolute;top: 7px;transform: rotate(90deg);width: 145px;left: 753px;" xmlns="http://www.w3.org/2000/svg"><path d="m321 199v291l62.67-.34h143.33c30.57 1 40.86-1 61-39.63l40-66c28.35-47.85 30-54.08 10.54-82l-52.91-89.25c-16.43-29.07-27.08-32.17-52-31.69h-212.13z" fill="#cd2e31" transform="translate(-321 -181)"/></svg>
